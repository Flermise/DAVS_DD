...
def get_txt_content(url):
    ...
    content2 = body_tag.find('div', {'class': 'vF_detail_content'})
    result = ''
    for tr in content:
...
class CcgpGovCnSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        if (url_num > 0) and (url_num <= 20):
            yield Request(url, meta={'kind': page_kind, 'type': page_type},callback=self.parse_page,dont_filter=True)
        elif url_num >= 20:
            ...
            for i in range(page_num):
                ...
                next_url = '&'.join(lts)
                yield Request(next_url, meta={'kind': page_kind, 'type': page_type}, callback=self.parse_page,dont_filter=True)
    ...
    def parse_page(self, response):
        ...
        for i in range(len(lis)):
            url_item = PageUrlItem()
            post_url = response.xpath('/html/body/div[5]/div[2]/div/div/div[1]/ul/li[' + str(i + 1) + ']/a/@href').extract_first("")
            url_item['url'] = post_url
            url_item['ptype'] = page_type
            url_item['kind'] = page_kind
            yield url_item
            if page_type == '更正公告':
    ...
    def parse_detail_7(self, response):
        ...
        item['project_name'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[2]/td[2]/text()').extract_first("")
        item['items'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[3]/td[2]/p/text()').extract_first("")
        item['url'] = response.url
        item['soft_hard'] = ''
        item['unit'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[4]/td[2]/text()').extract_first("")
        item['regions'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[5]/td[2]/text()').extract_first("")
        item['annou_time'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[5]/td[4]/text()').extract_first("")
        item['tender_annou_time'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[6]/td[2]/text()').extract_first("")
        item['winning_time'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[6]/td[4]/text()').extract_first("")
        item['experts'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[7]/td[2]/text()').extract_first("")
        item['total_money'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[8]/td[2]/text()').extract_first("")
        item['project_contact'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[10]/td[2]/text()').extract_first("")
        item['project_phone'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[11]/td[2]/text()').extract_first("")
        item['unit_address'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[13]/td[2]/text()').extract_first("")
        item['unit_contact_infor'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[14]/td[2]/text()').extract_first("")
        item['agent_name'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[15]/td[2]/text()').extract_first("")
        item['agent_address'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[16]/td[2]/text()').extract_first("")
        item['agent_contact'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[17]/td[2]/text()').extract_first("")
    ...
    def parse_detail_8(self, response):
        item = GZGGItem()
        item['project_num'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[3]/div/p[2]/text()').extract_first("")
        item['project_name'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[2]/td[2]/text()').extract_first("")
        item['items'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[3]/td[2]/p/text()').extract_first("")
        item['url'] = response.url
        item['soft_hard'] = ''
        ...
        item['regions'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[5]/td[2]/text()').extract_first("")
        item['annou_time'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[5]/td[4]/text()').extract_first("")
        item['first_annou_time'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[6]/td[2]/text()').extract_first("")
        item['correct_time'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[6]/td[4]/text()').extract_first("")
        item['project_contact'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[8]/td[2]/text()').extract_first("")
        item['project_phone'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[9]/td[2]/text()').extract_first("")
        item['unit_address'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[11]/td[2]/text()').extract_first("")
        item['unit_contact_infor'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[12]/td[2]/text()').extract_first("")
        item['agent_name'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[13]/td[2]/text()').extract_first("")
        item['agent_address'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[14]/td[2]/text()').extract_first("")
        item['agent_contact'] = response.xpath('//*[@id="detail"]/div[2]/div/div[2]/div/div[2]/table/tr[15]/td[2]/text()').extract_first("")
        txt_name = re.search(r"(\d+_\d+)", response.url).group(1)
        item['text_path'] = str(txt_name) + '.txt'
        item['file_save_path'] = ''
        item['file_urls'] = ''
